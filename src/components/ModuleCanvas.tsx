            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {modules.map((module) => {
                ...
                return (
                  <div
                    key={module.id}
                    className={`bg-white rounded-lg shadow-md border-2 transition-all cursor-pointer ${selectedModule === module.id
        ...
        <div className="w-96 bg-white shadow-lg border-l">
          ...
          <div className="p-4">
            <moduleDefinition.configComponent
              ...
              onConfigUpdate={(config: any) => handleConfigUpdate(selectedModuleData.id, config)}
