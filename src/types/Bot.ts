...
export interface BotSettings {
  ...
  // OpenRouter settings (Pro only - user brings their own key)
  openRouterApiKey?: string;

  // NOTE: geminiApiKey REMOVED - Gemini API key is NEVER stored client-side
  // It lives only in Netlify environment variables (GEMINI_API_KEY)
