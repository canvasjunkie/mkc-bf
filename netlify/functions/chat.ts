...
export default async (request: Request, context: Context) => {
    ...
    try {
        ...
        if (selectedProvider === 'gemini') {
            // RULE: Gemini API key ONLY comes from server environment variable
            // NEVER from bot config or frontend - this is a security requirement
            ...
            // RULE: ONE Gemini model only - hardcoded for cost efficiency and stability
            // Do NOT use model from frontend or bot config
